...
featureLayer = 'efficientnet-b0|model|head|dense|MatMul'; %extreurem característiques de les diferents capes
...
sgtitle('Corbes ROC per classe (EfficientNet-b0, efficientnet-b0|model|head|dense|MatMul, SVM, Distància Euclidiana)');
...
xtickangle(45);
ylabel('AUC');
title('AUC per classe (EfficientNet-b0, efficientnet-b0|model|head|dense|MatMul, SVM, Distància Euclidiana)');
grid on;
