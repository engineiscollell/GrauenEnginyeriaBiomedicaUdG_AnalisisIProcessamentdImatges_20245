...
net = resnet101;
featureLayer = 'fc1000'; % extreurem característiques de les diferents capes
...
sgtitle('Corbes ROC per classe (ResNet-101, fc1000, SVM, Distància Euclidiana)');
...
xtickangle(45);
ylabel('AUC');
title('AUC per classe (ResNet-101, fc1000, SVM, Distància Euclidiana)');
grid on;
